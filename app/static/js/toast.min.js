(function (a) {
    function f(c) {
        if (!a("#toast-container").length) {
            var d = "top-right top-left top-center bottom-right bottom-left bottom-center".split(" ").includes(a.toastDefaults.position) ? a.toastDefaults.position : "top-right";
        ...
        d = a("#toast-container");
        var b = "", e = b = "", g = "toast-" + l, f = c.type, t = c.title, m = c.subtitle, n = c.content, h = c.img,
            p = c.delay ? 'data-delay="' +
                c.delay + '"' : 'data-autohide="false"', q = "", r = a.toastDefaults.dismissible,
            u = a.toastDefaults.style.toast, k = !1;
        ...
        switch (f) {
            ...
            case "error":
                e =
                    a.toastDefaults.style.error || "bg-danger", b = a.toastDefaults.style.error || "text-white"
        }
        a.toastDefaults.pauseDelayOnHover && c.delay && (p = 'data-autohide="false"', q = 'data-hide-after="' + (Math.floor(Date.now() / 1E3) + c.delay / 1E3) + '"');
        b = '<div id="' + g + '" class="toast ' + u + '" role="alert" aria-live="assertive" aria-atomic="true" ' + p + " " + q + '><div class="toast-header ' + (e + " " + b + '">');
        h && (b += '<img src="' + h.src + '" class="mr-2 ' + (h["class"] || "") + '" alt="' + (h.alt || "Image") + '">');
        b += '<strong class="mr-auto">' + t + "</strong>";
        m && (b += '<small class="text-white">' + m + "</small>");
        r && (b += '<button type="button" class="ml-2 mb-1 close" data-dismiss="toast" aria-label="Close">\n                        <span aria-hidden="true" class="text-white">&times;</span>\n                    </button>');
        b += "</div>";
        ...
        a.toastDefaults.pauseDelayOnHover && (setTimeout(function () {
            ...
            var b = Math.floor(Date.now() / 1E3), c = parseInt(a(this).data("hideAfter"));
            k = !1;
